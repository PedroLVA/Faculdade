...
public class ConstrucaoDeAlgoritmo10 {
        ...
        while (continuar) {
            ...
            switch (entrada) {
                ...
                case "2":
                    ...
                    System.out.println("Escolha o dia da semana (Segunda-Sábado = 0-6):");
                    int dia = Integer.parseInt(sc.nextLine());
                    
                    // Enquanto n estiver na quantidade maxima de aulas                    
                    if (qntdAulas[dia] < 4) {
                        while (qntdAulas[dia] < 4) {
                            System.out.printf("Digite a %d aula de %s: ", qntdAulas[dia] + 1, nomeDias[dia]);
